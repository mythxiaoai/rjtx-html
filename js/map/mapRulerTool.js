...
;(function(win){
	function mapRulerTool(mapObj,rulerUrl,callback){
		...
		function cancelEvent(e){
			...
			/*if(defaultCursor!="url(http://api0.map.bdimg.com/images/openhand.cur) 8 8,default"){
				mapObj.setDefaultCursor("url(http://api0.map.bdimg.com/images/openhand.cur) 8 8,default");
			}*/
